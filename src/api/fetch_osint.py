...
def fetch_osint_data():
    ...
    for query in zoomeye_queries:
        ...
        if zoomeye_data:
            ...
            all_threats.append({"description": "Default threat description from ZoomEye", "risk": "low"})
    ...
    for ip in ip_addresses:
        ...
        if abuse_data:
            ...
            all_threats.append({"description": "Default threat description from AbuseIPDB", "risk": "low"})
    ...
    for email in email_patterns:
        ...
        if intelx_data:
            ...
            all_threats.append({"description": "Default threat description from IntelX", "risk": "low"})
